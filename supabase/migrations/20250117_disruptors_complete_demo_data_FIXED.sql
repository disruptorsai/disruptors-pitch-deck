-- =====================================================
-- DISRUPTORS MEDIA COMPLETE DEMO DATA (FIXED VERSION)
-- Compatible with the actual pricing_tiers table schema
-- Run this after: 20250113_ai_presenter_schema.sql
...
(
  ...
  2500.00,
  'monthly',
  '$2,500/month or $27,000/year (save 10%)',
  jsonb_build_array(
...
(
  ...
  5500.00,
  'monthly',
  '$5,500/month or $59,400/year (save 10%)',
  jsonb_build_array(
...
(
  ...
  12000.00,
  'monthly',
  '$12,000/month or $129,600/year (save 10%)',
  jsonb_build_array(
...
-- =====================================================
-- 3. ADD MORE CASE STUDIES (3 additional)
-- =====================================================
...
-- =====================================================
-- 4. ADD DEMO PROSPECT CLIENT WITH COMPETITIVE ANALYSIS
-- =====================================================

-- First, add a demo prospect client
...
SELECT name, price, is_highlighted
